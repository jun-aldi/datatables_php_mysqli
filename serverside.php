    ...
    <script type="text/javascript">
        $(document).ready(function(){
            $('#tabel-data').DataTable({
                ...
                "serverside" : true,
                "ajax" : "data.php",
                "columnDefs" : [{"render": tombol, "data":null, "targets":[3]}]
            });
        });

        function tombol(){
            return "<a href='dbedit.php?id_tma=$row[id_tma]' class='btn btn-info'>Edit</a> <a href='dbdelete.php?id_tma=$row[id_tma]' class='btn btn-danger'>Hapus</a>";
        }
    </script>
  </body>
</html>